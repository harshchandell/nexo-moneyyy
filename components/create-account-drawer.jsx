  ...
  return (
    <Drawer open={open} onOpenChange={setOpen}>
      ...
      <DrawerContent className="dark:bg-gray-800">
        <DrawerHeader>
          <DrawerTitle className="text-gray-900 dark:text-gray-100">Create New Account</DrawerTitle>
        </DrawerHeader>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="flex items-center justify-between rounded-lg border dark:border-gray-700 p-3">
              <div className="space-y-0.5">
                <label
                  htmlFor="isDefault"
                  className="text-base font-medium cursor-pointer text-gray-900 dark:text-gray-100"
                >
                  Set as Default
                </label>
